...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/join.css" />
</head>
		...
		<div class="row">
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<form id="join_form" class="join-form form-horizontal" role="form" action="${pageContext.request.contextPath}/index">
					<fieldset>
						<!-- 중복검사 확인 여부를 위한 값 -->
						<input id="ckd_id" name="ckd_id" type="hidden" value="1" />
						...
						<div class="form-group">
							...
							<span class="radio-inline"><input type="radio" name="gender" value="m" checked>남자</span>
							<span class="radio-inline"><input type="radio" name="gender" value="f">여자</span>
						</div>
						...
						<div class="form-group">
							...
							<span class="col-md-2"><input type="text" id="postcode" class="form-control" name="addrPost" placeholder="우편번호" readonly></span>
							<span class="col-md-5"><input type="text" id="address" class="form-control" name="addrRoad" placeholder="주소를 검색하세요." readonly></span>
...
제 1 조 (목적)
이 약관은 마이피씨에서 제공하는 인터넷서비스의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
