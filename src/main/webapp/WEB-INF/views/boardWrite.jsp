		...
		<div class="row">
			...
			<c:choose>
				<c:when test="${output.docno != null}">
					...
					<form id="board_up_form" class="form-horizontal boardWrite-form"
						role="form" action="${pageContext.request.contextPath}/boardMain">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<input id="subject" name="subject" type="text"
										placeholder="제목을 입력해 주세요." class="form-control"
							...
							<div class="form-group">
								<div class="col-md-offset-10 col-md-1">
									<button type="button"
										onclick="location.href='boardView?docno=${output.docno}'"
										class="btn btn-primary boardWrite-btn">뒤로가기</button>
								</div>
								<div class="col-md-1">
				...
				<c:otherwise>
					...
					<form id="board_post_form" class="form-horizontal boardWrite-form"
						role="form" action="${pageContext.request.contextPath}/boardMain">
						<fieldset>
							<div class="form-group">
								<label for="boardWrite-input02" class="col-md-1 control-label">제목:</label>
							...
							<div class="form-group">
								<div class="col-md-offset-10 col-md-1">
									<button type="button" onclick="location.href='boardMain'"
										class="btn btn-primary boardWrite-btn">뒤로가기</button>
								</div>
								<div class="col-md-1">
